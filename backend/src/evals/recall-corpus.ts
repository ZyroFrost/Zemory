...
export const RECALL_CORPUS: LabeledQuery[] = [
  ...
  { q: "sửa đoạn giải thích về máng lề và đường phân cách của cột chênh lệch trong trang web DuAnA", lang: "vi", kind: "tool_use", session: "4f1ea683-0a03-41fa-aec2-9252a4300a03", uuid: "fab00b80-441e-461e-a724-c9f70632ec79" },
  ...
  { q: "chạy trong DuAnC, trỏ tới tệp todo và tệp bàn giao nằm bên thư mục tạm của phiên", lang: "vi", kind: "tool_use", session: "d158fb77-fce8-43ed-ba9d-50822825eaa1", uuid: "09a651e8-2390-4b06-b8d1-c8aa75a7e19d" },
  ...
  { q: "chạy lại launcher nq của repo PBI_DuAnA_Maintain ở bước điền, xem còn sinh rác ở gốc không", lang: "vi", kind: "tool_use", session: "5ccc6d83-f120-4b37-8f6c-086b526c4e43", uuid: "f283b2b6-0b0e-4802-bd02-41731dd23f1d" },
