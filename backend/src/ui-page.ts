...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* Settings modal — tabbed, one fixed size (see 03_STRUCTURE §5 Dialog / modal). */
  ...
  /* Dialog harness — pick ONE fixed size at open time (see 03_STRUCTURE §5 Dialog / modal).
...
<script>
  ...
  function renderStatus(){
    ...
    const STD = [['AGENTS.md', 'AGENTS.md'], ['01_CONSTITUTION.md', 'agent/01_CONSTITUTION.md'], ['02_RULES.md', 'agent/02_RULES.md'], ['03_STRUCTURE.md', 'agent/03_STRUCTURE.md'], ['04_SKILLS.md', 'agent/04_SKILLS.md'], ['05_TODO.md', 'agent/05_TODO.md'], ['06_CHANGES.md', 'agent/06_CHANGES.md']];
