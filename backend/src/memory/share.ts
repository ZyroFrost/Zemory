 ...
 * đã hội tụ. Đo 2026-08-12 trên Drive thật: `MAY-B.000003` (1.312 phiên · 235.839
 * tin · 331 MB) và `MAY-A.000024` (1.314 · 238.422 · 336 MB) gần như CÙNG nội dung —
 ...
 * `MAY-C` để lại 9 file ~338 MB). Đây là ca sẽ LẶP mỗi lần đổi máy.
 *
