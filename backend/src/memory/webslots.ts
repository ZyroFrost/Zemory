...
// ── DANH TÍNH vs KHE ─────────────────────────────────────────────────────────────────────
//
// Đo 2026-08-28: khe `main` của claude từng đăng nhập `tai.khoan@canhan.example` (83 phiên, project
// cá nhân), rồi hôm nay đăng nhập lại bằng `tai.khoan@congty.example`. Cây gán nhãn khe theo email
