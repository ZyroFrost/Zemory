...
const CH_HEADER =
  "<!-- GENERATED by zemory from global_memory.db · hand-edits WELCOME (file wins) — new entries merge into the DB on `zemory docs sync`; `zemory changelog add` also works -->\n# Change Log\n\n> Mới nhất ở trên. Đảo/thay quyết định cũ → `> 🔄 Supersede:`.\n\n---\n\n";
