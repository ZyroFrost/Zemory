...
//  · `PBI_DuAnA_Maintain/06_CHANGES.md` viết head dạng `## 2026-07-28 — tiêu đề` (KHÔNG
...
// Dạng của PBI_DuAnA_Maintain — ngày không ngoặc, em-dash.
const BARE = `# PWB_DuAnA_Maintain — Change Log
