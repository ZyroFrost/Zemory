...
1. **ĐỌC skill liên quan trước** (dùng công cụ tra của nó nếu có); nếu nó không phủ vấn đề → nói RÕ "skill không có match", đừng bịa.
...
4. **User có ý tưởng UI mới** → check skill để **gợi ý lại** trước khi build (đối chiếu với chuẩn skill, nêu rủi ro/lựa chọn tốt hơn).
