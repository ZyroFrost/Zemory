...
| 4 | `docs/agent/02_RULES.md` | `<RAW>/agent/02_RULES.md` | 141 |
...
| 21 | `.claude/skills/audit/SKILL.md` | `<RAW>/.claude/skills/audit/SKILL.md` | 46 |
...
| 26 | `docs/hooks/guard.cjs` | `<RAW>/hooks/guard.cjs` | 491 |
