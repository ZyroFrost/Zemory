...
| **engine graph** (import-graph · symbol · docs-graph · touches) | LỒNG trong domain (`backend/src/<domain>/`), KHÔNG slot thứ 5 (HP điều graph); consumer ngoài đọc `graph export` versioned |
