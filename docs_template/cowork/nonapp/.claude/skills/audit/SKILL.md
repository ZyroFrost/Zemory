...
**② Nguồn trùng**
Cùng một sự thật nằm ở **≥2 nơi** ⇒ chắc chắn sẽ lệch. Soi: metric định nghĩa ở `dictionary.md` nhưng tính khác trong `measures/` · cùng một truy vấn chép ở hai chỗ · file/thư mục ngoài chuẩn · docs lặp nội dung của nhau.
