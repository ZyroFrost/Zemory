...
Zemory được xây bottom-up như phân hệ **memory + harness (governance/docs) + RAG** nền của **A.I Center**. Vision và roadmap cấp hệ thống nằm tại `D:\Work_Study\IT\Data\Tools\a.i_center\docs\plan\`; Zemory không tự nhân bản nội dung đó. Quyết định A.I Center gọi package Zemory hay hợp nhất repo chỉ được chốt khi lớp memory và localhost API ổn định.
## 2. Slot `memory`: Global Memory hoàn chỉnh
...
- `memory_search`: trả ID, nguồn, project, thời gian và snippet từ Global Memory;
- `memory_show`: mở đúng một message, tùy chọn kèm context lân cận;
