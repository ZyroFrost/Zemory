...
Dialog / modal       CHỈ 3 size cố định S/M/L (S ~30vw/≤45vh=xác nhận · M ~50vw/≤70vh=form · L ~72vw/≤85vh=log·bảng; trần ≤94vw/≤90vh, canh giữa) — chọn 1 lần lúc mở theo nội-dung+mục-đích, KHÔNG random/đổi-động/reflow loạn. Tràn → cuộn TRONG dialog (overflow:auto), KHÔNG phình theo nội dung. Trạng thái layout user chỉnh (resize/vị-trí/size) phải LƯU + khôi phục y nguyên. Token/size ở frontend/styles/
