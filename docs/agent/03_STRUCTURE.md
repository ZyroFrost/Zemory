...
| **engine graph** (import-graph · symbol · docs-graph · touches) | LỒNG trong domain (`backend/src/<domain>/` — vd brain), KHÔNG slot thứ 5 (HP điều 13); consumer ngoài đọc `graph export` versioned |
