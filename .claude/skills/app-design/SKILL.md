...
**⑦ MỘT KÊNH THỊ GIÁC = MỘT HẠNG THÔNG TIN** *(user chốt 2026-09-17: "cái khung sáng đánh dấu pin là đang bị ảo")*. Viền · nền · đậm nhạt là các KÊNH riêng; mỗi kênh chỉ được một hạng làm chủ. Hai trạng thái khác hạng cùng đòi một kênh thì **kẻ khai báo sau thắng, kẻ kia biến mất mà không cổng nào báo** — và nếu hai màu còn gần nhau (đo được ca thật: `--primary` #FFD166 vs `--warn` #FBBF24 cùng làm viền thẻ dự án) thì ngay cả khi không đè nhau, mắt vẫn đọc ra CÙNG một nghĩa ⇒ người dùng đếm 6 thẻ "đã ghim" trong khi hệ chỉ ghim 2. Cách làm: chọn lựa · lệch chuẩn · cảnh báo giữ **viền**; trạng thái người dùng bật (ghim/khoá/theo dõi) chuyển sang **nền** hoặc một dấu riêng — rồi hai thứ chồng nhau vẫn đọc được cả hai. Nghiệm thu bằng SỐ trên DOM thật (`getComputedStyle`), đừng tin ảnh chụp.
